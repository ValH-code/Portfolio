...
const projects = [
  {
    id: 'bibliotracker',
    title: 'BiblioTracker',
    description: 'Application de gestion de bibliothèque personnelle permettant aux utilisateurs de cataloguer, organiser et suivre leurs collections de livres.',
    longDescription: 'Une application web complète offrant une expérience utilisateur intuitive pour gérer sa bibliothèque personnelle. Fonctionnalités incluant la recherche avancée, les recommandations personnalisées, et le suivi des prêts.',
  ...
  },
  {
    id: 'coming-soon-1',
    title: 'À venir',
    description: 'Un nouveau projet passionnant est en cours de développement. Restez à l\'écoute pour plus d\'informations.',
    longDescription: 'Ce projet innovant utilisera les dernières technologies web pour créer une expérience utilisateur unique. Plus de détails seront révélés prochainement.',
  ...
  },
  {
    id: 'coming-soon-2',
    title: 'À venir',
    description: 'Un projet innovant qui sera bientôt dévoilé. Les détails seront partagés dans un futur proche.',
    longDescription: 'Une nouvelle solution créative qui repoussera les limites de la technologie web moderne. Restez connectés pour découvrir ce projet unique.',
          ...
          >
            <Card className="h-full flex flex-col overflow-hidden border-border/50 group hover:shadow-xl transition-all duration-300 hover:scale-[1.02]">
              ...
              <CardFooter className="flex gap-2 pt-4">
                {project.liveUrl && (
                  <Button asChild variant="default" size="sm" className="flex-1 transition-transform hover:scale-105">
                ...
                {project.githubUrl && (
                  <Button asChild variant="outline" size="sm" className="flex-1 transition-transform hover:scale-105">
